...
书架目录下自动生成按月隔离的活动日志 `activity-YYYY-MM.md`，记录所有书架变动：
...
| 时间 | 操作 | 书名 | 作者 | 备注 |
|------|------|------|------|------|
| 06-15 14:22 | ➕ 补充 | 三体 | 刘慈欣 | kgbook |
| 06-14 09:05 | ❤️ 删除 | 活着 | 余华 | 用户喜欢 |
| 06-13 02:00 | ⏰ 过期 | 百年孤独 | 马尔克斯 | 在架30天 |
```

每条操作实时记录，最新记录在最上方。每月自动切换到新文件，无需手动清理。
